...
//	@FindBy(xpath = "//button[@type='button']//span[text()='Post Getter']")
	...
	@FindBy(xpath = "//p[text()='URL no es v谩lida']")
	...
	@FindBy(xpath = "//span[text()='French - fran莽ais']")
...
//	public WebElement Ellipsis_Icon;
	...
	@FindBy(xpath = "(.//*[normalize-space(text()) and normalize-space(.)='路'])[1]/following::*[name()='svg'][1]")
	...
	public WebElement Home_btn_fran胊is;

	@FindBy(xpath = "(//a[@href='/settings/my-account']//parent::div//a)[4]")
	public WebElement profile_Btn_fran胊is;

	@FindBy(xpath = "//a[@href='/notifications']")
	public WebElement notification_Btn_fran胊is;

	@FindBy(xpath = "//div[contains(text(),'Param猫tres')]")
	public WebElement settings_Btn_fran胊is;

	@FindBy(xpath = "//div[contains(text(),'Assistance')]")
	public WebElement Help_Center_Btn_fran胊is;
