...
//	public WebElement btnSearch;
    ...
    public allFunctions open(String url) {
        driver.get(url);
        return this;
    }
    public allFunctions open() {
        driver.get("https://gettr.com/");
        return this;
    }
    ...
    public void login(String username, String password) throws InterruptedException 
    {
		...
		System.out.println("Login with email clicked");
...
//		ExtentReportListener.log("Post Getter button is clicked ");
	...
	public void check_tile(String expectedTitle) {
	...
	public void login_guru() {
		
		locator.usernameGuru.sendKeys("sampleUsername");;
		locator.passwordGuru.sendKeys("password");
		locator.submitGuru.click();
	}
